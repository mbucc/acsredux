...
var $author$project$EditText$DiaryIdAndDay = F2(
	function (a, b) {
		return {$: 'DiaryIdAndDay', a: a, b: b};
	});
var $author$project$EditText$Invalid = {$: 'Invalid'};
var $author$project$EditText$NoteID = function (a) {
	return {$: 'NoteID', a: a};
};
var $author$project$EditText$initContentID = function (_v0) {
	var id = _v0.a;
	var date = _v0.b;
	var _v1 = _Utils_Tuple2(id, date);
	if (_v1.a.$ === 'Just') {
		if (_v1.b.$ === 'Nothing') {
			var x = _v1.a.a;
			var _v2 = _v1.b;
			return $author$project$EditText$NoteID(x);
		} else {
			var x1 = _v1.a.a;
			var x2 = _v1.b.a;
			return A2($author$project$EditText$DiaryIdAndDay, x1, x2);
		}
	} else {
		if (_v1.b.$ === 'Just') {
			var _v3 = _v1.a;
			return $author$project$EditText$Invalid;
		} else {
			var _v4 = _v1.a;
			var _v5 = _v1.b;
			return $author$project$EditText$Invalid;
...
var $author$project$EditText$BadUrl = function (a) {
	return {$: 'BadUrl', a: a};
};
var $author$project$EditText$NetworkError = {$: 'NetworkError'};
var $author$project$EditText$Timeout = {$: 'Timeout'};
var $author$project$EditText$parseResponse = function (serverHTTPResponse) {
	switch (serverHTTPResponse.$) {
		case 'BadUrl_':
			var url = serverHTTPResponse.a;
			return $elm$core$Result$Err(
				$author$project$EditText$BadUrl(url));
		case 'Timeout_':
			return $elm$core$Result$Err($author$project$EditText$Timeout);
		case 'NetworkError_':
			return $elm$core$Result$Err($author$project$EditText$NetworkError);
		case 'BadStatus_':
			var metadata = serverHTTPResponse.a;
			var body = serverHTTPResponse.b;
			return (metadata.statusCode === 400) ? $elm$core$Result$Err(
				A2(
					$author$project$EditText$BadStatus,
					metadata.statusCode,
					$elm$core$Maybe$Just(body))) : $elm$core$Result$Err(
				A2($author$project$EditText$BadStatus, metadata.statusCode, $elm$core$Maybe$Nothing));
		default:
			var body = serverHTTPResponse.b;
							...
							$elm$http$Http$request(
								{
									...
									expect: A2($elm$http$Http$expectStringResponse, $author$project$EditText$SaveRequest, $author$project$EditText$parseResponse),
									headers: _List_Nil,
									method: 'PUT',
							...
							$elm$http$Http$post(
								{
									body: A2(
										...
										'entryDate=' + ($elm$url$Url$percentEncode(dateString) + ('&text=' + $elm$url$Url$percentEncode(model.newMarkdown)))),
									expect: A2($elm$http$Http$expectStringResponse, $author$project$EditText$SaveRequest, $author$project$EditText$parseResponse),
...
var $author$project$EditText$deadEndsToString = function (deadEnds) {
	return A2(
		$elm$core$String$join,
		'\n',
...
var $author$project$EditText$editButton = function (model) {
	return A2(
		$elm$html$Html$button,
		_List_fromArray(
			[
				...
				$elm$html$Html$Attributes$id(
				'edit-' + $author$project$EditText$elementID(model.contentID))
			]),
		_List_fromArray(
			[
				$elm$html$Html$text(
				$elm$core$String$isEmpty(model.markdown) ? 'Add a diary entry.' : 'Edit')
			]));
};
